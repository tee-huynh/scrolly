...
var scrollVis = function () {
  ...
  var barColors = { 0: '#00c5fc', 1: '#ff993f', 2: '#ff4c5e' };
  ...
  var setupVis = function (wordData, fillerCounts, histData) {
    ...
    var squares = g.selectAll('.square').data(wordData, function (d) { return d.nothing; });
    ...
    barText.enter()
      ...
      .attr('dx', 15)
      .attr('y', function (d, i) { return yBarScale(i);})
      .attr('dy', yBarScale.bandwidth() / 1.7)
  ...
  function getHistogram(data) {
    ...
    var thirtyMins = data.filter(function (d) { return d.time; });
    ...
    return d3.histogram()
      ...
      .value(function (d) { return d.time; })(thirtyMins);
  }
  ...
  function groupByWord(words) {
    return d3.nest()
      .key(function (d) { return d.nothing; })
...
d3.tsv('data/scrollproto3.txt', display);
